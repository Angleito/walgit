...
export const walrusConfigSchema = {
  // Official Walrus API endpoints from documentation
  endpoints: {
    [NETWORKS.DEVNET]: 'https://walrus-devnet-api.mystenlabs.com',
    [NETWORKS.TESTNET]: 'https://walrus-testnet-api.mystenlabs.com',
    [NETWORKS.MAINNET]: 'https://walrus-mainnet-api.mystenlabs.com'
  },
