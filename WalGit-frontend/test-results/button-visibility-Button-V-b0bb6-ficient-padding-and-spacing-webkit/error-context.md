...
- Name: Button Visibility Tests >> all buttons should have sufficient padding and spacing
- Location: /Users/angle/CascadeProjects/walgit/WalGit-frontend/tests/button-visibility.spec.ts:58:3
...
Expected: >= 4
Received:    0
    at /Users/angle/CascadeProjects/walgit/WalGit-frontend/tests/button-visibility.spec.ts:82:68
```
