  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-4 md:p-8 bg-black">
      ...
      <section className="w-full max-w-6xl mx-auto relative overflow-hidden rounded-lg p-8 md:p-12 mb-16">
        ...
        <div className="relative z-10">
          <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white font-mono tracking-tight">
            <span className="text-[#05d9e8] glow glow-blue-500-md animated-bounce-sm">WalGit</span>
            <span className="block mt-2 animated-fade-in-up animated-duration-1000">Crypto Cyberpunk Edition</span>
          </h1>
          <p className="text-xl text-gray-300 mb-8 max-w-2xl animated-fade-in animated-delay-300 animated-duration-1000">
            Decentralized version control with blockchain security and futuristic cyberpunk UI
          </p>
      ...
      <section className="w-full max-w-6xl mx-auto mb-16">
        <h2 className="text-3xl font-bold text-[#00ff9f] mb-8 font-mono text-center glow glow-green-500-sm animated-fade-in-down animated-duration-1000">Core Features</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <CyberpunkCard
            ...
            pulseEffect={true}
            scanlineEffect={true}
            className="animated-fade-in-left animated-delay-100"
          >
            <h3 className="text-xl font-bold text-[#05d9e8] mb-3 glow glow-blue-400-sm">Decentralized Storage</h3>
            <p className="text-gray-300">Store your code securely on the blockchain with optimized blob management</p>
          </CyberpunkCard>
          ...
          <CyberpunkCard
            ...
            glowIntensity="md"
            pulseEffect={true}
            className="animated-fade-in-up animated-delay-300"
          >
            <h3 className="text-xl font-bold text-[#ff2a6d] mb-3 glow glow-red-400-sm">Smart Contracts</h3>
            <p className="text-gray-300">Version control powered by Sui Move smart contracts for secure operations</p>
          </CyberpunkCard>
          ...
          <CyberpunkCard
            ...
            pulseEffect={true}
            scanlineEffect={true}
            className="animated-fade-in-right animated-delay-500"
          >
            <h3 className="text-xl font-bold text-[#00ff9f] mb-3 glow glow-green-400-sm">Advanced Merges</h3>
            <p className="text-gray-300">Conflict resolution with blockchain validation and secure history</p>
          </CyberpunkCard>
        </div>
      </section>
      ...
      {/* Repository Cards */}
      <section className="w-full max-w-6xl mx-auto mb-16 animated-fade-in animated-duration-1000 animated-delay-700">
        <h2 className="text-3xl font-bold text-[#bf5af2] mb-8 font-mono text-center glow glow-purple-400-sm">Repository Cards</h2>
      ...
      <footer className="w-full py-8 border-t border-gray-800 mt-16 text-center animated-fade-in animated-duration-1000 animated-delay-1500">
        <div className="relative">
          ...
          <p className="text-gray-400 relative z-10 font-mono">
            <span className="text-[#05d9e8] glow glow-blue-400-sm">WalGit</span> <span className="text-[#ff2a6d] glow glow-red-400-sm">Cyberpunk</span> <span className="text-[#00ff9f] glow glow-green-400-sm">Edition</span> • Decentralized Version Control
          </p>
